class DropBoxController {
    ...
    connectFirebase() {
      const config = {
        apiKey: "AIzaSyAZwQ_246AuU-aSyr_UlCaH4cJKXIUTcho",
        authDomain: "dropbox-clone-131d7.firebaseapp.com",
        databaseURL: "https://dropbox-clone-131d7-default-rtdb.firebaseio.com",
        projectId: "dropbox-clone-131d7",
        storageBucket: "dropbox-clone-131d7.appspot.com",
        messagingSenderId: "282409585656",
        appId: "1:282409585656:web:595ee3867e92b8febe240d"
      };
      // Initialize Firebase
    ...
    renderNav(){
      ...
      for (i; i < this.currentFolder.length; i++){
